          ...
          <div className="flex-shrink-0">
            ...
            >
              <img 
                src={logo} 
                alt="Alley Logo" 
                className="w-12 h-12 object-contain group-hover:scale-105 transition-smooth filter brightness-0 invert group-hover:brightness-100 group-hover:invert-0 group-hover:hue-rotate-[315deg] group-hover:saturate-150"
              />
            </button>
          </div>
